...
from tifffile import imsave #type: ignore
...
hpf_ft = highpass_gaussian_kernel_fourier(fwhm_to_sigma(z_res_real/nm_per_pix), N=data_normal.size(2)).to(device)
...
for _ in range(1000):
    ...
    for i in range(50):
        ...
        def closure():
            ...
            projections = torch.stack([data_x_projection, data_y_projection, reco_z_projection], dim=0)
